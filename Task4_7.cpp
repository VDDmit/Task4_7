...
// Task4_7.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTask47App, CWinApp)
...
// Единственный объект CTask47App

CTask47App theApp;


// Инициализация CTask47App

BOOL CTask47App::InitInstance()
{
